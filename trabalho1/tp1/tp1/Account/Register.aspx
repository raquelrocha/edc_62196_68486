    ...
    <div class="form-horizontal">
        ...
        <asp:ValidationSummary runat="server" CssClass="text-danger" />
         <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="FullName" CssClass="form-control" TextMode="SingleLine" width="300" />
         ...
         <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="BirthDate" CssClass="form-control" TextMode="Date" width="280" />
